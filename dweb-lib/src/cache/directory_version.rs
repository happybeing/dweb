...
//! do a FileTree history (History<FileTree>).
...
/// a specific version of a FileTree.
///
...
/// a History<FileTree> which acts like a local DNS.
/// Key:     SHORTNAME
...
pub struct DirectoryVersion {
    ...
    /// Address of a TroveHistory<trove::FileTree> on Autonomi (saves lookup based on SHORTNAME.www-dweb.au)
